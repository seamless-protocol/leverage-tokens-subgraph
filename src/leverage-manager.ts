...
export function handleMint(event: MintEvent): void {
  ...
  position.collateral = position.collateral.plus(event.params.actionData.collateral)
  position.debt = position.debt.plus(event.params.actionData.debt)
  position.collateralInDebt = BigInt.zero()
  position.debtInCollateral = BigInt.zero()
  position.equityInCollateral = position.equityInCollateral.plus(event.params.actionData.equity)
  ...
  leverageToken.totalCollateralInDebt = BigInt.zero()
  leverageToken.totalDebt = leverageToken.totalDebt.plus(position.debt)
  leverageToken.totalDebtInCollateral = BigInt.zero()
  leverageToken.totalEquityInCollateral = leverageToken.totalEquityInCollateral.plus(position.equityInCollateral)
  leverageToken.totalEquityInDebt = BigInt.zero()
  ...
  leverageManagerDebtAssetStats.totalDebt = leverageManagerDebtAssetStats.totalDebt.plus(position.debt)
