...
export const MORPHO_CHAINLINK_ORACLE_V2_RLP_USDC_ADDRESS = "{{ethereum.MorphoChainlinkOracleV2-RLP-USDC.address}}"
...
export const SIUSD_ADDRESS = "{{ethereum.siUSD.address}}"
